...
! ------------------------------------------------------------------------!
  Subroutine M_sumDataDouble1D(dataArray)
! force declaration of all variables
    Implicit None
...
! mpi variables
    ...
    Integer(kind=StandardInteger) :: error,tag
    Integer, Dimension(MPI_STATUS_SIZE) :: status
    Integer(kind=StandardInteger) :: processTo,processFrom
    Real(kind=DoubleReal), Dimension(:) :: dataArray
    Real(kind=DoubleReal), Dimension(1:size(dataArray)) :: sendArray, recvArray
! Array size
...
! -----------------------------------------
    Call M_distDouble1D(dataArray)
  End Subroutine M_sumDataDouble1D
